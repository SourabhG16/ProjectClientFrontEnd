...
module.exports = "active-item {\n  border-left: 8px solid var(--ion-color-primary); }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "page-home .spinner-container {\n  width: 100%;\n  text-align: center;\n  padding: 10px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ModalPage = /** @class */ (function () {
    ...
    ModalPage.prototype.doNothing = function () {
        var _this = this;
        this.geolocation.getCurrentPosition().then(function (resp) {
            ...
            _this.routeservice.Source(18.500314, 73.861234).subscribe(function (res) {
                if (res != null) {
                    _this.src = res;
                    _this.srcbool = true;
                    _this.global_var.Unreachable = false;
                }
                else {
                    _this.global_var.Unreachable = true; //setting unreachable to true
                    _this.presentAlert();
                }
            });
...
var RouteService = /** @class */ (function () {
    ...
    RouteService.prototype.Source = function (latitude, longitude) {
        ...
        return this.http.post('http://localhost:3000/api/first/login/findstation', data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (e) {
    ...
    RouteService.prototype.Search = function (credentials) {
        ...
        return this.http.post('http://localhost:3000/api/first/login/searchdest', data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (e) {
            _this.showAlert(e.error.msg);
            throw new Error(e);
        }));
        // }
    ...
    RouteService.prototype.TripRecord = function (data) {
        ...
        console.log(data);
        return this.http.post('http://localhost:3000/api/first/login/triprecord', data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (e) {
            _this.showAlert(e.error.msg);
            throw new Error(e);
        }));
    };
    RouteService.prototype.Transaction = function (data) {
        ...
        return this.http.post('http://localhost:3000/api/first/login/transaction', data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (e) {
            _this.showAlert(e.error.msg);
            throw new Error(e);
        }));
    };
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.register = function (credentials) {
        var _this = this;
        return this.http.post('http://localhost:3000/api/first/register', credentials).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (e) {
            _this.showAlert(e.error.msg);
            throw new Error(e);
        }));
    };
    ...
    AuthService.prototype.getSpecialData = function () {
        var _this = this;
        return this.http.get('http://localhost:5000/api/special').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (e) {
            var status = e.status;
            if (status === 401) {
...
module.exports = __webpack_require__(/*! C:\Users\Roggh\Desktop\Client\src\main.ts */"./src/main.ts");
